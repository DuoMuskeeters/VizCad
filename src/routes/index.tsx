...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* HERO SECTION */}
      <section className="relative bg-gradient-to-br from-gray-50 to-white pt-24 pb-16 sm:pt-32 sm:pb-20 xl:pt-32 xl:pb-16 overflow-hidden min-h-screen flex items-center">
          ...
          <div className="flex flex-col xl:grid xl:grid-cols-2 gap-16 sm:gap-20 xl:gap-16 xl:items-center">
            ...
            <div className="space-y-12 sm:space-y-14 xl:space-y-10 text-center xl:text-left">
              <div className="space-y-8 sm:space-y-10 xl:space-y-8">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold text-gray-900 leading-tight text-center xl:text-left">
                  Visualize Your
                  <span className="block text-cyan-500">3D Models</span>
                  <span className="block">Instantly</span>
                </h1>
                <p className="text-xl sm:text-2xl lg:text-2xl xl:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto xl:max-w-2xl xl:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 justify-center xl:justify-start">
                <Button
                  asChild
                  size="lg"
                  className="bg-cyan-500 hover:bg-cyan-600 text-white px-10 py-5 xl:px-10 xl:py-5 text-xl font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all transform hover:scale-105"
                >
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-gray-300 text-gray-700 hover:bg-gray-50 px-10 py-5 xl:px-10 xl:py-5 text-xl font-semibold rounded-xl bg-transparent hover:border-gray-400 transition-all"
              ...
              <div className="flex flex-wrap items-center gap-8 xl:gap-8 text-base text-gray-500 justify-center xl:justify-start">
            ...
            <div className="relative group flex justify-center xl:justify-start">
              {/* Application Preview */}
              <div className="relative bg-white rounded-2xl xl:rounded-3xl shadow-xl xl:shadow-2xl border border-gray-200 overflow-hidden group-hover:scale-105 transition-transform duration-700 ease-out w-full max-w-xl xl:max-w-none">
                <div className="flex items-center gap-2 px-5 py-4 xl:px-6 xl:py-4 bg-gray-50 border-b border-gray-200">
                  ...
                  <div className="flex gap-6 xl:gap-6 mb-6 xl:mb-6">
                    <div className="flex-1 space-y-4 xl:space-y-4">
                      <div className="flex gap-2 xl:gap-2">
                        <div className="px-4 py-2 xl:px-4 xl:py-2 bg-cyan-100 text-cyan-700 rounded-full text-sm font-medium">
                          Scenes
                        </div>
                        <div className="px-4 py-2 xl:px-4 xl:py-2 bg-gray-100 text-gray-600 rounded-full text-sm">
                          Lights
                        </div>
                        <div className="px-4 py-2 xl:px-4 xl:py-2 bg-gray-100 text-gray-600 rounded-full text-sm">
                          Camera
                      ...
                      <div className="space-y-3 xl:space-y-3">
                        <div className="h-20 xl:h-20 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl border border-cyan-200 flex items-center justify-center">
                          <Upload className="w-8 h-8 xl:w-8 xl:h-8 text-cyan-500" />
                        </div>
                        <div className="grid grid-cols-2 gap-3 xl:gap-3">
                          <div className="h-16 xl:h-16 bg-gradient-to-br from-gray-50 to-white rounded-lg border border-cyan-500"></div>
                          <div className="h-16 xl:h-16 bg-gradient-to-br from-gray-100 to-gray-50 rounded-lg border"></div>
                        </div>
                      </div>
                    </div>
                    <div className="flex-[2] bg-gray-100 rounded-xl flex items-center justify-center min-h-[200px] xl:min-h-[200px]">
                      <div className="text-center space-y-3 xl:space-y-3">
                        <Box className="w-16 h-16 xl:w-16 xl:h-16 text-gray-400 mx-auto" />
                        <div className="text-lg xl:text-lg text-gray-600 font-medium">
                          3D Viewer
                        </div>
                        <div className="text-sm xl:text-sm text-gray-500">
              ...
              {/* Floating Elements */}
              <div className="absolute -top-6 -right-6 xl:-top-6 xl:-right-6 w-20 h-20 xl:w-20 xl:h-20 bg-cyan-500 rounded-3xl flex items-center justify-center shadow-xl group-hover:animate-pulse transition-all duration-300 group-hover:shadow-2xl">
                <Camera className="w-10 h-10 xl:w-10 xl:h-10 text-white" />
              </div>
              <div className="absolute -bottom-6 -left-6 xl:-bottom-6 xl:-left-6 w-16 h-16 xl:w-16 xl:h-16 bg-purple-500 rounded-2xl flex items-center justify-center shadow-xl group-hover:animate-pulse transition-all duration-300 group-hover:shadow-2xl">
                <Lightbulb className="w-8 h-8 xl:w-8 xl:h-8 text-white" />
              </div>
              <div className="absolute top-1/2 -left-4 xl:-left-4 w-12 h-12 xl:w-12 xl:h-12 bg-green-500 rounded-xl flex items-center justify-center shadow-lg group-hover:animate-bounce transition-all duration-300 group-hover:shadow-xl">
                <Palette className="w-6 h-6 xl:w-6 xl:h-6 text-white" />
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-24 justify-items-center">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 p-6 lg:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl hover:border-cyan-200 transition-all duration-300 hover:-translate-y-2 w-full max-w-sm flex flex-col items-center text-center">
              ...
              <p className="text-base text-gray-600 leading-relaxed flex-1 flex items-center">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 p-6 lg:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl hover:border-green-200 transition-all duration-300 hover:-translate-y-2 w-full max-w-sm flex flex-col items-center text-center lg:mt-12">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 p-6 lg:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl hover:border-orange-200 transition-all duration-300 hover:-translate-y-2 w-full max-w-sm flex flex-col items-center text-center">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 p-6 lg:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl hover:border-purple-200 transition-all duration-300 hover:-translate-y-2 w-full max-w-sm flex flex-col items-center text-center">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 p-6 lg:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl hover:border-blue-200 transition-all duration-300 hover:-translate-y-2 w-full max-w-sm flex flex-col items-center text-center lg:mt-12">
            ...
            <div className="group bg-gradient-to-br from-white to-gray-50 p-6 lg:p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-2xl hover:border-red-200 transition-all duration-300 hover:-translate-y-2 w-full max-w-sm flex flex-col items-center text-center">
